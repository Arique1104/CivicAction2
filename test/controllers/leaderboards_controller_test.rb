...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference("Leaderboard.count") do
      post leaderboards_url, params: { leaderboard: { deadline: @leaderboard.deadline, description: @leaderboard.description, end_date: @leaderboard.end_date, start_date: @leaderboard.start_date } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { deadline: @leaderboard.deadline, description: @leaderboard.description, end_date: @leaderboard.end_date, start_date: @leaderboard.start_date } }
